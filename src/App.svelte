...
<main class="overflow-hidden">
  <div id="nav" class="fixed w-28 min-w-24 h-12 rounded-xl items-center justify-center flex flex-row shadow-xl bg-teal-400 dark:bg-teal-700 m-9">
    ...
    <a href="/#about" class="m-2 cursor-default">
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-house w-8" viewBox="0 0 16 16">
